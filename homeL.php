...
<div class="tudo">
    <section class="pricing-section">
        ...
        <?php
        // Bloco PHP REINSERIDO: Este código busca os produtos no banco de dados e cria a variável $produtos_home
        
        // A conexão já foi incluída no topo do arquivo, então apenas usamos $pdo
        $produtos_home = null; // Inicializa a variável para evitar Warning
        try {
            ...
            // Se der erro, $produtos_home será null, mas a variável já foi inicializada, então o erro Fatal sumirá.
        }
        ?>
  ...
  <div class="envoltura-suprema">
    <div class="recipiente-conteudo">
      ...
      <a href="contato.html" class="acao-botão-primario">
        Comece
      </a>
